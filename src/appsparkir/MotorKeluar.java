...
public class MotorKeluar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Data Motor Keluar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String nopol = jTextPane1.getText();
        a.setNoPol(nopol);
        String jam_keluar = jTextPane2.getText();
        a.setJamKeluar(jam_keluar);
        String update = a.QUpdateMT();
        DBHelper b = new DBHelper();
        b.motorKeluar(update);
